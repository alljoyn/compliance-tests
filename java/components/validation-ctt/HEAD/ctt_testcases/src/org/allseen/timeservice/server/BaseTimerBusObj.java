...
public abstract class BaseTimerBusObj implements BusObject /* implements Timer */{
       ...
       /* if (needAnnounce) {
            ...
            for (String announcedInterface : announcedInterfaces) {
                ...
                try {
                    ...
                    Log.info("Added announced interface: '" + announcedInterface + "'");
                } catch (TimeServiceException tse) {
                    Log.error("Failed to setAnnounceFlag to true, interface: '" + announcedInterface + "'", tse);
                    throw tse;
                }
            }
        }*/
    ...
    public PeriodAJ getInterval() throws BusException {
        ...
        try {
            ...
            Log.debug("getInterval is called, objPath: '" + objectPath + "', handling");
            ...
            Log.error("Failed to execute 'getInterval', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }

        Log.debug("Returning Interval: '" + periodAJ + "', objPath: '" + objectPath + "'");
        return periodAJ;
    }
    ...
    public void setInterval(PeriodAJ periodAJ) throws BusException {
        ...
        try {
            ...
            Log.debug("setInterval is called, setting to: '" + periodAJ + "', objPath: '" + objectPath + "'");

            getBus().enableConcurrentCallbacks();
            getTimer().setInterval(periodAJ.toPeriod());
        } catch (IllegalArgumentException ilae) {

            Log.error("Failed to execute 'setInterval', objPath: '" + objectPath + "'", ilae);
            throw new ErrorReplyBusException(TimeServiceConst.INVALID_VALUE_ERROR, ilae.getMessage());
        } catch (Exception e) {

            Log.error("Failed to execute 'setInterval', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    public PeriodAJ getTimeLeft() throws BusException {
        ...
        try {
            ...
            Log.debug("getTimeLeft is called, objPath: '" + objectPath + "', handling");
            ...
            Log.error("Failed to execute 'getTimeLeft', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }

        Log.debug("Returning TimeLeft: '" + periodAJ + "', objPath: '" + objectPath + "'");
        return periodAJ;
    }
    ...
    public boolean getIsRunning() throws BusException {
        ...
        try {
            ...
            Log.debug("getIsRunning is called, objPath: '" + objectPath + "', handling");

            isRunning = getTimer().isRunning();
        } catch (Exception e) {

            Log.error("Failed to execute 'getIsRunning', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }

        Log.debug("Returning IsRunning: '" + isRunning + "', objPath: '" + objectPath + "'");
        return isRunning;
    }
    ...
    public short getRepeat() throws BusException {
        ...
        try {
            ...
            Log.debug("getRepeat is called, objPath: '" + objectPath + "', handling");

            repeat = getTimer().getRepeat();
        } catch (Exception e) {

            Log.error("Failed to execute 'getRepeat', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }

        Log.debug("Returning repeat: '" + repeat + "', objPath: '" + objectPath + "'");
        return repeat;
    }
    ...
    public void setRepeat(short repeatTimes) throws BusException {
        ...
        try {
            ...
            Log.debug("setRepeat is called, setting to: '" + repeatTimes + "', objPath: '" + objectPath + "'");

            getBus().enableConcurrentCallbacks();
            getTimer().setRepeat(repeatTimes);
        } catch (ErrorReplyBusException erbe) {

            Log.error("Failed to execute 'setRepeat', objPath: '" + objectPath + "'", erbe);
            throw erbe;
        } catch (Exception e) {

            Log.error("Failed to execute 'setRepeat', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    public String getTitle() throws BusException {
        ...
        try {
            ...
            Log.debug("getTitle is called, objPath: '" + objectPath + "', handling");
            ...
            Log.error("Failed to execute 'getTitle', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }

        Log.debug("Returning title: '" + title + "', objPath: '" + objectPath + "'");
        return title;
    }
    ...
    public void setTitle(String title) throws BusException {
        ...
        try {
            ...
            Log.debug("setTitle is called. Setting to: '" + title + "', objPath: '" + objectPath + "'");

            getBus().enableConcurrentCallbacks();
            getTimer().setTitle(title);
        } catch (Exception e) {

            Log.error("Failed to execute 'setTitle', objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    public void start() throws BusException {
        ...
        try {
            ...
            Log.debug("Timer start is called, objPath: '" + objectPath + "',  handling");
            getTimer().start();
        } catch (Exception e) {

            Log.error("Failed to start the Timer, objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    public void pause() throws BusException {
        ...
        try {
            ...
            Log.debug("Timer pause is called, objPath: '" + objectPath + "', handling");
            getTimer().pause();
        } catch (Exception e) {

            Log.error("Failed to pause the Timer, objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    public void reset() throws BusException {
        ...
        try {
            ...
            Log.debug("Timer reset is called, objPath: '" + objectPath + "', handling");
            getTimer().reset();
        } catch (Exception e) {

            Log.error("Failed to reset the Timer, objPath: '" + objectPath + "'", e);
            throw new ErrorReplyBusException(TimeServiceConst.GENERIC_ERROR, e.getMessage());
        }
    }
    ...
    void sendTimerEvent() throws TimeServiceException {
        ...
        try {
            ...
            Log.debug("Emitting TimerEvent signal, TTL: '" + TIMER_EVENT_TTL_SECONDS + "', objPath: '" + objectPath + "'");
    ...
    void sendRunStateChanged(boolean isRunning) throws TimeServiceException {
        ...
        if (sid == null) {
            ...
            Log.warn("No session is established with the Timer, unable to send 'RunStateChanged' signal");
            return;
        }
        ...
        try {
            ...
            Log.debug("Emitting RunStateChanged signal, IsRunning: '" + isRunning + "', objPath: '" + objectPath + "'");
    ...
    void release() {
        ...
        Log.debug("Releasing Server Timer object, objPath: '" + objectPath + "'");
        timer = null;
        try {
       ...
       /* if (announcedInterfaces != null && announcedInterfaces.length > 0) {
            for (String announcedInterface : announcedInterfaces) {
                try {
                    ...
                    Log.info("Removed announced interface: '" + announcedInterface + "'");
                } catch (TimeServiceException tse) {
                    Log.error("Failed to setAnnounceFlag to false, interface: '" + announcedInterface + "'", tse);
                }
            }
