...
public class TimerFactory extends ObjectIntrospector {
    ...
    public Timer newTimer() throws TimeServiceException {
        ...
        Log.debug("Creating NewTimer, objPath: '" + objectPath + "'");
        ...
        Log.debug("Created NewTimer: '" + timer + "', objPath: '" + objectPath + "'");
    ...
    public void deleteTimer(String objectPath) throws TimeServiceException {
        ...
        Log.debug("Deleting Timer: '" + objectPath + "', objPath: '" + objectPath + "'");
    ...
    public List<Timer> retrieveTimerList() throws TimeServiceException {
        ...
        Log.debug("Retrieving List of Timers, objPath: '" + objectPath + "'");
        ...
        Log.debug("Returning List of Timers: {" + timers + "}, objPath: '" + objectPath + "'");
        return timers;
    }
